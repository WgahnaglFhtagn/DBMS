...
public class Orders extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            NewOrder na = new NewOrder((Frame) this.getParent(), true, connection);
            na.setVisible(true);
            model.updateData();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTable1.getSelectedRow() >= 0) {
            try {
                NewOrder na = new NewOrder((Frame) this.getParent(), true, connection, model.getSelectesItem(jTable1.getSelectedRow()));
                na.setVisible(true);
                model.updateData();
                ((AbstractTableModel) jTable1.getModel()).fireTableDataChanged();
            } catch (SQLException ex) {
        ...
        try {
            if (jTable1.getSelectedRow() >= 0) {
                try {
                    ...
                    statement.executeUpdate("delete from order1 where ID=" 
